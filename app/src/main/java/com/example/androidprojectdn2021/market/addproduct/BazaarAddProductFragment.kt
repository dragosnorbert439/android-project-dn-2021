...
class BazaarAddProductFragment : Fragment(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addProductViewModel =
            ViewModelProvider(this, addProductViewModelFactory).get(AddProductViewModel::class.java)
    }
    ...
    override fun onCreateView(
        ...
        // SWITCH
        view.findViewById<Switch>(R.id.activeSwitchAddProductLayout)
            .setOnCheckedChangeListener { buttonView, isChecked ->
                if (isChecked) buttonView.text = "Active" else buttonView.text = "Inactive"
            }
        ...
        launchButton.setOnClickListener {
            ...
            val description =
                view.findViewById<TextInputEditText>(R.id.descriptionTITEAddProdLayout)
            ...
            val isActive: Boolean =
                view.findViewById<Switch>(R.id.activeSwitchAddProductLayout).isChecked
            val amountType =
                view.findViewById<Spinner>(R.id.dropDownSpinnerAmountAPL).selectedItem.toString()
            val priceType =
                view.findViewById<Spinner>(R.id.dropDownSpinnerCurrencyAPL).selectedItem.toString()
            if (title.text?.isEmpty() == true) {
                ...
                addProductViewModel.addProductRequest = AddProductRequest(
                    title = title.text?.trimEnd().toString(),
                    description = description.text.toString(),
                    price_per_unit = price.text.toString(),
                    units = amount.text.toString(),
                    is_active = isActive,
                    rating = 0.0,
